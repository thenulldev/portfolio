...
export function ErrorState({ title, error, className = "" }: ErrorStateProps) {
  return (
    <div className={`mx-auto bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-2xl p-8 w-full sm:w-auto max-w-7xl border border-red-200 dark:border-red-800 shadow-lg ${className}`}>
